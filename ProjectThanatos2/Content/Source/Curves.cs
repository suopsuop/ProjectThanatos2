...
//				float offset = MathF.Sin((float)bullet.framesAlive / 20f) * 100f;

//				bullet.position = new Vector2(-offset + bullet.initialPosition.X, -(float)bullet.speed + bullet.position.Y);
